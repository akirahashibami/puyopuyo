class Stage {
  ...
  static initialize() {
    ...
    zenkeshiImage.style.postition = 'absolute';
    ...
    for(let y = 0; y < Config.stageRows; y++) {
      cosnt line = this.board[y] || (this.board[y] = []);
  ...
  static showZenkeshi() {
    ...
    const animation = () => {
      const ratio = Math.min((Data.now() - startTime) / Config.zenkeshiDuration, 1);
